...
public class DatabaseManager {
    ...
    public DatabaseManager(PGUtils plugin) {
        ...
        prefix = plugin.getConfig().getString("db.prefix", "pgutils_");
        host = plugin.getConfig().getString("db.host", "localhost");
        port = plugin.getConfig().getInt("db.port", 3306);
        database = plugin.getConfig().getString("db.dbname", "pgutils");
        username = plugin.getConfig().getString("db.user", "root");
        password = plugin.getConfig().getString("db.pass", "");
        type = plugin.getConfig().getString("db.type", "mysql");
    }
